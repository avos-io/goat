...
mkdir -p gen
protoc --go_out=gen --go_opt=paths=source_relative --go-grpc_out=gen --go-grpc_opt=paths=source_relative --experimental_allow_proto3_optional ./protorepo/goat/rpc.proto $grpc_opts

mkdir -p gen/testproto
protoc --go_out=gen/testproto --go_opt=paths=source_relative --go-grpc_out=gen/testproto --go-grpc_opt=paths=source_relative --experimental_allow_proto3_optional ./test.proto $grpc_opts
